...
import org.heigit.ors.api.requests.pt.PublicTransportRequest;
...
@RestController
@Api(value = "Public Transport Service", tags = "Public Transport")
@SwaggerDefinition(tags = {
        @Tag(name = "Public Transport", description = "Get directions for public transport")
})
@RequestMapping("/v2/pt")
@ApiResponses({
...
public class PublicTransportAPI {
    ...
    @PostMapping
    @ApiOperation(value = "", hidden = true)
    public String getPostMapping(@RequestBody PublicTransportRequest request) throws MissingParameterException {
        throw new MissingParameterException(RoutingErrorCodes.MISSING_PARAMETER, "profile");
    }
    ...
    public GeoJSONRouteResponse getSimpleGeoJsonRoute(@ApiParam(value = "Specifies the route profile.", required = true, example = "driving-car") @PathVariable APIEnums.Profile profile,
        ...
        PublicTransportRequest request = new PublicTransportRequest(start, end);
    ...
    public JSONRouteResponse getDefault(@ApiParam(value = "Specifies the route profile.", required = true, example = "driving-car") @PathVariable APIEnums.Profile profile,
                                        @ApiParam(value = "The request payload", required = true) @RequestBody PublicTransportRequest request) throws StatusCodeException {
